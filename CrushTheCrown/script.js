...
function getSizeRight()
{
	...
	{
		$(".game-container").css({"transform" : "scale(0.6)", "-webkit-transform" : "scale(0.6)", "-moz-transform" : "scale(0.6)"});
	}
	else
	{
		$(".game-container").css({"transform" : "none","-webkit-transform" : "none","-moz-transform" : "none"});
	}
}
